...
def visualize_trajectory_2d(pose, total_u_t, path_name="Unknown", show_ori=False):
    '''
    ...
    '''
    #se3 is special euclidean group
    ...
    #new
    ax.scatter( total_u_t[0,:,-1], total_u_t[1,:,-1], s=10, marker = 'o'  )
    #end
    if show_ori:
